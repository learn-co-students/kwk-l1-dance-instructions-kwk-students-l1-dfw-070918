...
def bob_the_reins
  puts "Holding your arms out in front of you, Do straight and at chest level"
...
def lasso
  ...
  puts "Raise right forearm so that it points straight up, and Do whip it in small circles to the beat of the song, as if you were a cowboy holding a rope lasso. This movement is repeated eight times as well."
end 
